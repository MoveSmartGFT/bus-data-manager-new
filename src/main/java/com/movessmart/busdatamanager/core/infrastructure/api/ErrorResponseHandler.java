...
public class ErrorResponseHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleEntityAlreadyExistsException(
        ...
        ProblemDetail body = createProblemDetail(
                ex, HttpStatus.CONFLICT, ex.getMessage(), null, new String[] {ex.getObjectType(), ex.getId()}, request);
    ...
    protected ResponseEntity<Object> handleEntityStatusException(EntityStatusException ex, WebRequest request) {
        ProblemDetail body = createProblemDetail(
                ex,
                HttpStatus.NOT_FOUND,
                ex.getMessage(),
