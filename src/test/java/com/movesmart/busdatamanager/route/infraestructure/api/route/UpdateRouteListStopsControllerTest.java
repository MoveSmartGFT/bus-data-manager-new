...
public class UpdateRouteListStopsControllerTest {
    ...
    @Test
    @DisplayName(
            "GIVEN a Route Stop List update request is received WHEN all the stops exist THEN returns updated route object and status 200")
    ...
    @Test
    @DisplayName(
            "GIVEN a Route Stop List update request is received WHEN one or more stops do not exist THEN returns status 404")
