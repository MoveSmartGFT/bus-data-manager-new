...
public class DisableStopControllerTest {
    ...
    @Test
    @DisplayName("GIVEN a stop disable request is received WHEN the stop exists THEN returns stop object disabled and status 200")
    void testDisable() throws Exception {
        ...
        mockMvc.perform(
                        patch(StopController.STOP_PATH+StopController.STOP_ID_PATH+StopController.STOP_DISABLE_PATH, stop.getId())
                )
