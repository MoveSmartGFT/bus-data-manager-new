...
public class EnableStopControllerTest {
    ...
    @Test
    @DisplayName("GIVEN a stop enable request is received WHEN the stop exists THEN returns stop object enabled and status 200")
    void testEnable() throws Exception {
        ...
        mockMvc.perform(
                        patch(StopController.STOP_PATH+StopController.STOP_ID_PATH+StopController.STOP_ENABLE_PATH, stop.getId())
                )
