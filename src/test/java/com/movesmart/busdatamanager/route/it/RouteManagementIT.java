...
public class RouteManagementIT extends EndPointRouteInventory {
    ...
    void routeIT() throws Exception {
        ...
        CreateRouteRequest firstCreateRouteRequest = Instancio.create(RouteInstancioModels.getCreateRouteRequestModelWithStops(List.of(stop.getId())));
        CreateRouteRequest secondCreateRouteRequest = Instancio.create(RouteInstancioModels.getCreateRouteRequestModelWithStops(List.of(stop.getId())));
        Route firstRoute = Instancio.create(RouteInstancioModels.getRouteModelFromCreateRequest(firstCreateRouteRequest));
        Route secondRoute = Instancio.create(RouteInstancioModels.getRouteModelFromCreateRequest(secondCreateRouteRequest));
        ...
        Route firstCreatedRoute = objectMapper.readValue(createRouteResponse.getResponse().getContentAsString(), Route.class);
...
/*        MvcResult routeConflictResponse = createRouteRequest(firstCreateRouteRequest);
        ...
        Route secondCreatedRoute = objectMapper.readValue(createSecondRouteResponse.getResponse().getContentAsString(), Route.class);
